...
func TestGetTenantID(t *testing.T) {
	ctx := appcontext.WithTenantID(context.Background(), "test-tenant-id")
...
func TestGetTenantDB(t *testing.T) {
	db := &sql.DB{}
	ctx := appcontext.WithTenantDB(context.Background(), db)
...
func TestGetUserID(t *testing.T) {
	ctx := appcontext.WithUserID(context.Background(), "user-123")
