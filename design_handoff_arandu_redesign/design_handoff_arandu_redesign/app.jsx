    ...
    <div style={{ display: "flex", minHeight: "100vh", background: "var(--paper)" }} data-screen-label={`01 ${page}`}>
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", minWidth: 0 }}>
        ...
        <main style={{
          ...
          {page === "agenda"    && <Placeholder label="Agenda" />}
          {page === "notes"     && <Placeholder label="Prontuários" />}
          {page === "insights"  && <Placeholder label="Inteligência Clínica" />}
        </main>
      </div>
...
waitForGlobals([
  ...
  "DashboardPage", "PatientPage", "SessionPage", "LLMPanel", "TweaksPanel",
], mount);
